...
namespace ApplicationRegainDeBase {
	...
	// car elle sont non managées, à l'inverse de BDCreationSphere qui DOIT l'être car elle hérite
	// de System::Windows::Forms::Form --> en désespoir de cause, je les mets là.
	extern AttributsFaces		AFSphere ;
	extern AttributsSolides		ASSphere ;
	extern SolidesP				LaSphereConstruite ;
	extern const Materiaux		*PMatSphere ;	// Rappel : on manipule les matériaux au travers de pointeurs

	/// <summary>
	/// Description résumée de BDCreationSphere
	/// </summary>
	public ref class BDCreationSphere : public System::Windows::Forms::Form
	{
	public:
		BDCreationSphere(void)
		{
			InitializeComponent();

			//TODO: ajoutez ici le code du constructeur
			PMatSphere = PMateriauJaune ;
			AFSphere = AttributsFaces	(PMatSphere) ;
			LaSphereConstruite = Spheres (Points3D (0,0,0),20,&ASSphere, &AFSphere) ;
			LogicielsGraphiquesBase::Defaut ()->AfficherSolide (LaSphereConstruite) ;
		}
...
//#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBoxXCentre->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &BDCreationSphere::textBoxXCentre_KeyUp);
			// 
			// textBoxYCentre
			// 
			...
			this->textBoxYCentre->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &BDCreationSphere::textBoxXCentre_KeyUp);
			// 
			// textBoxZCentre
			// 
			...
			this->textBoxZCentre->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &BDCreationSphere::textBoxXCentre_KeyUp);
			// 
			// textBoxR
			// 
			...
			this->textBoxR->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &BDCreationSphere::textBoxXCentre_KeyUp);
			// 
			...
			this->buttonChangerCouleur->Click += gcnew System::EventHandler(this, &BDCreationSphere::buttonChangerCouleur_Click);
			// 
			// buttonOK
			// 
			...
			this->buttonOK->Click += gcnew System::EventHandler(this, &BDCreationSphere::buttonOK_Click);
			// 
			// buttonAnnuler
			// 
			...
			this->buttonAnnuler->Click += gcnew System::EventHandler(this, &BDCreationSphere::buttonAnnuler_Click);
			// 
			// BDCreationSphere
			// 
			...
			this->Name = L"BDCreationSphere";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Création d\'une sphère";
...
//#pragma endregion
	...
	// sphère actuelle par une nouvelle sphère, avec ces paramètres
	{
		...
		if (LaSphereConstruite.EstInitialise ()) {
			LogicielsGraphiquesBase::Defaut ()->EffacerSolide (LaSphereConstruite) ;
			LaSphereConstruite.Detruire () ;
		}
		if (ToutVaBien) {
			LaSphereConstruite = Spheres (Points3D (XC, YC, ZC), R, &ASSphere, &AFSphere) ;
			LogicielsGraphiquesBase::Defaut ()->AfficherSolide (LaSphereConstruite) ;
		}
	}
